    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                <img id="carouselImage" src="{{ asset('images/default.jpg') }}" class="img-fluid rounded mb-3" alt="Imagen del Módulo" style="max-height: 300px; object-fit: contain;">
                <p id="imageDescription" class="text-muted text-center">Pasa el puntero sobre un botón para ver su imagen.</p>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center"> {{-- Centrar las tarjetas dentro de la columna derecha --}}
            <div class="col-md-10 col-lg-8 mb-3"> {{-- col-md-10 para menos anchura en pantallas medianas, col-lg-8 para pantallas grandes --}}
                <div class="card text-white bg-primary module-card"
                     data-image="{{ asset('images/inventario.jpg') }}"
            ...
            <div class="col-md-10 col-lg-8 mb-3">
                <div class="card text-white bg-info module-card"
                     data-image="{{ asset('images/mantenimientos.jpg') }}"
            ...
            <div class="col-md-10 col-lg-8 mb-3">
                <div class="card text-white bg-dark module-card"
                     data-image="{{ asset('images/usuarios.jpg') }}"
            ...
            <div class="col-md-10 col-lg-8 mb-3">
                <div class="card text-white bg-warning module-card"
                     data-image="{{ asset('images/alertas.jpg') }}"
            ...
            <div class="col-md-10 col-lg-8 mb-3">
                <div class="card text-white bg-info module-card"
                     data-image="{{ asset('images/movimientos.jpg') }}"
